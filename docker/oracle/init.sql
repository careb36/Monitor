...
GRANT CONNECT, RESOURCE, CREATE TABLE TO "&MONITOR_APP_USER";

-- LogMiner privileges for Debezium
GRANT SELECT ANY TRANSACTION TO "&MONITOR_APP_USER";
GRANT LOGMINING TO "&MONITOR_APP_USER";
GRANT CREATE SESSION TO "&MONITOR_APP_USER";
